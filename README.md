...
- defaultstations.json — JSON-масив з елементами {title:'...',url:'...'}, де title — назва станції, url — посилання на онлайн-трансляцію
...
- Люкс FM відсутнє через особливості їхньої онлайн-трансляції.
